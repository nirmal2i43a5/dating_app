...
from dating_app.views import ChangePasswordView,Register,Login, ListUserDetail,   DetailUser
...
urlpatterns = [
    ...
    path('api/listUser/', ListUserDetail, name='list-user'),
     path('api/detailUser/<str:pk>/', DetailUser, name='detail-user'),
